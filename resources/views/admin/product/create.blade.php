            ...
            <div class="row mg-b-25">
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_name" placeholder="Enter product name" required="" style="font-style: italic;">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Product Code: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="product_code" placeholder="Enter product code" required="" style="font-style: italic;">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">Quantity: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="product_quantity" placeholder="Enter quantity" required="" style="font-style: italic;">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="selling_price" placeholder="Enter product price" required="" style="font-style: italic;">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
                <div class="form-group">
